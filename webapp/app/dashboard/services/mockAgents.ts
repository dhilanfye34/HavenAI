...
export const mockRecommendations: Recommendation[] = [
  {
    ...
    context: 'Vulnerability Scanner found outdated OpenSSH on one monitored host.',
  },
  {
    id: 'rec-2',
    title: 'Review 3 new outbound connections from last 24h',
    context: 'Network Monitor saw unusual destinations outside the normal baseline.',
  },
  {
    id: 'rec-3',
    title: 'Enable 2FA on your admin account',
    context: 'Threat Intelligence flagged account takeover campaigns targeting admin users.',
  },
  {
    id: 'rec-4',
    title: 'Investigate repeated PowerShell encoded command usage',
    context: 'Process Analyzer detected multiple encoded PowerShell invocations.',
  },
];
