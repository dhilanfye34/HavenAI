      ...
      <div className="mt-3 space-y-2">
        {recommendations.map((recommendation) => (
          <button
            ...
            className="w-full rounded-lg border border-gray-700 bg-gray-800 p-3 text-left text-sm text-gray-200 transition hover:border-cyan-400/40 hover:bg-gray-700"
          >
